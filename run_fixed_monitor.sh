cd ~/monitoring && pkill -f monitor.py 2>/dev/null || true

cat > monitor_fixed.py << 'EOF'
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class Monitor:
    ...
    def start(self):
        """بدء النظام"""
        print("🚀 بدء المراقبة الشاملة - نسخة مصححة")
        print("=" * 50)
...
chmod +x monitor_fixed.py
python3 monitor_fixed.py